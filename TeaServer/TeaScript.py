...
game_states = ( ("SETTING_UP", "No one here yet...\n\n(PRESS BUTTON AFTER DINNER, WHEN READY FOR REGINA TO ARRIVE)"),
                ("FAMILY_PICTURES", "George's here with photographer \n\n(wands off, fireplace off, table twinkling)\n\n(PREVIOUS BUTTON PRESS SHOULD SKIP THIS STATE...)"),
                ("GROUP_PICTURES", "Everyone here with photographer \n\n(wands off, fireplace off, table twinkling)\n\n(PREVIOUS BUTTON PRESS SHOULD SKIP THIS STATE...)"),
                ("REGINA_ARRIVES", "<BANG NOISES> Everyone should be eating dinner \n\n(wands off, fireplace fire, table twinkling)"),
                ("REGINA_EXPLAINS", "Regina realizes she is stuck in the fireplace. She explains and welcomes everyone. \n\n(wands off, fireplace talking, table twinkling)"),
                ("DINNER", "Everyone eats dinner \n\n(wands off, fireplace fire, table twinkling)\n\n(PRESS BUTTON ABOUT 5 MINUTES BEFORE POISONING...)"),
                ("FOGGER_WARMUP", "Fogger turns on.... \n\n(wands off, fireplace fire, table twinkling with fogger warming)"),
                ("FOGGER_COUNTDOWN", "Red snake pattern \n\n(wands off, fireplace fire, table red snake with fogger warming)"),
                ("POISONING", "Fog starts coming out \n\n(wands off, fireplace fire, table lightes off with fogger fogging)\n\n  (PRESS BUTTON WHEN FOGGER STARTS)"),
                ("EVIL_ANNOUNCEMENT", "'I am the evil dark wizard Asmodean! You have invaded my domain and will be eliminated!'   \n\n(wands off, fireplace fire, table lights off, fogger fogging)"),
                ("CAST_PROHIBERE", "<SIREN>'Oh no! You are getting poisoned! Quick! Pick up your wands, give them a shake, and say PROHIBERE!' \n\n(wands buzzing, fireplace talking, table lights off, fogger fogging)"),
                ("WAIT_ON_PROHIBERE", "<SIREN>Wands turn on as people cast spell... \n\n(wands lighting, fireplace fire, table lights off, fogger fogging)"),
                ("FOGGER_OFF", "Enough people casted spell...siren off. \n\n(wands lit, fireplace fire, table lights off, fogger off)"),
                ("REGINAS_PLAN", "'Oh no!!! You have all been poisoned! We have to find the cure right away or the unimaginable could happen!' \n\n(wands off, fireplace talking)"),
                ("SPELL_BOOKS_APPEAR", "'Frigidarium!!! <POW!> Someone check the freezer, I just sent some help there!' \n\n(wands off, fireplace talking)"),
                ("PASS_OUT_BOOKS", "'Witch Weekly just had a delightful article on poisoning - I think it will do the trick!  Everyone get a copy!' \n\n(wands off, fireplace talking)\n\n(PRESS BUTTON WHEN BOOKS ARE PASSED OUT)"),
                ("ANTIDOTE_EXPLANATION", "'Witch weekly just had an article on poisoning, I think it should have everything you need. But first find the squib's pumpkin and take a bite.'"),
                ("REGINA_SUGGESTS_PUMPKIN_CAKE", "Extra state, auto-skipped"),
                ("EATING_PUMPKIN_CAKE", "Everyone eats the cake\n\n(PRESS BUTTON AFTER EVERYONE HAS EATEN CAKE...)"),
