...
for esp in esps:
    ...
    #cmd = 'python C:/Users/jay_d/Documents/ArduinoData/packages/esp32/hardware/esp32/1.0.3/tools/espota.py -i ' + esp[0] + ' -I ' + ip_of_sender + ' -p ' + sender_to_esp_port+' -P '+esp_respond_sender_port+' -a '+update_password+' -f '+esp[1]
